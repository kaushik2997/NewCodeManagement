...
14. Create a python file named kn-copy.py
15. Edit the python file
  a. Open the file
  b. Enter a line of code
  c. Run the file
16. While keeping the current terminal window for project,  open a new terminal for git to manage the source code) then cd repo
...
24. Go to Cloud9 and create a second python file: kn2-flask.py
...
28. In the terminal, run the file: python3 kn2-flask.py
...
@app.route('/')
def hello_world():
   return 'Project done by Kaushik and Imran'
